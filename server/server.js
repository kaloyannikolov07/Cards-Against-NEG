...
const blackCardsSeed = [
  ...
  "Каназирска чете конско, защото .",
  "Манова написа отсъствия, заради.",
  "Най-големият стрес в НЕГ е ___.",
  "Нено влезе и каза: ___.",
  "Най-доброто оправдание за закъснение: ___.",
  "В междучасието всички говорят само за ___.",
  ...
  "Първото междучасие винаги е за___.",
  "Вакарелски чу 'Ваканция' и си помисли___.",
  "Kaiser-ът на НЕГ се знае с___.",
  "Изпитът винаги е полят, когато___.",
  "Най-голямата разлика между Leistung и DSD е___.",
  "Всеки заек в Немската знае за___.",
  "Завършилите НЕГ се връщат да преподават, заради___.",
  "Учениците се сближават най-много покрай___.",
  "Няма Реденка без___.",
  "През часовеге редовно си мисля за___.",
  "Нено е 26-тият най-велик българин, благодарение на___."
];
...
const whiteCardsSeed = [
  ...
  "училищният Wi-Fi, който не работи",
  ...
  "огромният ни двор",
  "дрескoдът на Нели Георгиева",
  "синият аутфит на г-жа Цуцуманова",
  "липсата на тоалетна хартия",
  "общият кенеф на втория етаж",
  "да те хванат с пищoв",
  "футбол на двора",
  "нормативи по Физическо",
  "поредното закъснение",
  "стипендията, която стига за 2 кафета",
  "Lidl trip в голямото",
  "Слънчака с Мис Петрова",
  "жегата юни месец",
  "мъката с DSD Mappe-тата",
  "хубав мохабет в час по английски",
];
